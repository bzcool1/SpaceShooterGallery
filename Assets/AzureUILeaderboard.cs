...
public class AzureUILeaderboard : MonoBehaviour 
{
	...
	[SerializeField]
	public string AzureEndPoint = "https://spaceshootergallery.azure-mobile.net/"; // Your Connection URL
	
	[SerializeField]
	public string ApplicationKey = "cMzrBEhlWRWEXGfRyqFTLCopuoYNfp94"; // Your API Key
